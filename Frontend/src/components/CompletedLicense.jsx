...
function CompletedLicense({ vendor, closeModal }) {
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 p-4 z-50">
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-3xl h-[90vh] flex flex-col overflow-hidden z-50">
        {/* Header */}
        ...
        <div ref={licenseRef} className="overflow-y-auto p-6 flex-grow">
          <div
            className="border-4 border-yellow-600 p-6 bg-white shadow-md text-left flex flex-col"
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 text-lg mb-6">
              <p>
                <strong>License No:</strong> {vendor.license.licenseNumber}
              </p>
              <p>
              ...
              <p>
                ...
                {vendor.license.documents.businessName}
              </p>
              <p>
                <strong>Business Category:</strong> {vendor.category || "N/A"}
              </p>
              <p>
                <strong>GST Number:</strong>{" "}
                {vendor.license.documents.gstNumber || "Not Provided"}
              </p>
              <p>
              ...
              <p>
                ...
                {vendor.license.documents.yearsInBusiness || "N/A"}
              </p>
              <p>
                <strong>Issued On:</strong>{" "}
                {new Date(vendor.license.approvedAt).toLocaleDateString()}
              </p>
              <p className="col-span-2">
                <strong>Business Description:</strong>{" "}
                {vendor.license.documents.businessDescription || "Not Provided"}
              </p>
            </div>
